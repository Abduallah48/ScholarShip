        ...
        <div className="relative bg-slate-200 rounded-2xl p-4 w-full max-w-2xl h-120 border-slate-300 border-2 shadow-xl shadow-indigo-300 mx-auto flex flex-col gap-6 justify-center items-center ">
            ...
            {docScreen === "Documents" &&   <div className=" flex flex-col gap-8">
                                                    ...
                                                    <div className="flex gap-4">
                                                        <button onClick={GoToCV} className="bg-indigo-300 px-4 py-2 rounded-2xl border border-indigo-500 text-lg font-bold text-indigo-700">CV</button>
                                                        <button onClick={GoToMotivation} className="bg-indigo-300 px-4 py-2 rounded-2xl border border-indigo-500 text-lg font-bold text-indigo-700">Motivation Letter</button>
                                                        <button onClick={GoToLetter} className="bg-indigo-300 px-4 py-2 rounded-2xl border border-indigo-500 text-lg font-bold text-indigo-700">Recomendation Letter</button>
                                                    </div>
                                            </div>}
