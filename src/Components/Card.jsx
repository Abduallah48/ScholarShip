    ...
    return(
        ...
        <div className="flex flex-col gap-2 border max-w-sm p-4 rounded-xl shadow-lg shadow-indigo-700 hover:shadow-md transition-all duration-300 bg-white
            ...
            <div className='flex gap-4 justify-end'>
                <button onClick={moveToSholarship} className="bg-indigo-500 font-semibold text-white rounded-2xl px-4 py-2 cursor-pointer shadow-xl/20  hover:bg-indigo-600 transition-all duration-300">عرض تفاصيل المنحة </button>
